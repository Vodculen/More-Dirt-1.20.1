...
import net.vodculen.moredirt.blocks.custom.InfertileBlock;
...
public class ModBlocks {
	...
	public static final Block ARID_DIRT = registerBlock("arid_dirt", new FallingBlock(AbstractBlock.Settings.copy(Blocks.SAND)));
	public static final Block INFERTILE_MULCH = registerBlock("infertile_mulch", new InfertileBlock(AbstractBlock.Settings.copy(Blocks.FARMLAND).sounds(BlockSoundGroup.MUD), Blocks.DIRT));
	public static final Block FERTILE_MULCH = registerBlock("fertile_mulch", new FertileBlock(AbstractBlock.Settings.copy(Blocks.FARMLAND).sounds(BlockSoundGroup.MUD), ModBlocks.INFERTILE_MULCH));
	...
	// Modded Grass
	public static final Block CHARRED_GRASS_BLOCK = registerBlock("charred_grass_block", new CharredBlock(AbstractBlock.Settings.copy(Blocks.GRASS), addCharredGrassBlockTransformablesFromNearbyBlock(), Blocks.GRASS_BLOCK));
