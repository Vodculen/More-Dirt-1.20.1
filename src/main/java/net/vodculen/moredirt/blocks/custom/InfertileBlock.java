...
public class InfertileBlock extends Block {
	...
	public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
		...
		if (!isWaterNearby(world, pos) && !world.hasRain(pos.up()) && moisture > 0) {
	...
	public static void turnInfertile(@Nullable Entity entity, BlockState state, World world, BlockPos pos) {
		BlockState blockState = pushEntitiesUpBeforeBlockChange(state, FertileBlock.transformedBlock.getDefaultState(), world, pos);
